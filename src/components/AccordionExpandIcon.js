        ...
        <div>
            <Accordion>
                <AccordionSummary
                    ...
                    className={`cursor-pointer p-2 rounded-lg flex items-center transition-all duration-300 ${isComapnyClicked ? "bg-blue-500 text-white" : "bg-transparent"
                        }`}
                    style={{
            ...
            <Accordion defaultExpanded>
                <AccordionSummary
                    onClick={handleClick}
                    className={`cursor-pointer p-2 rounded-lg flex items-center transition-all duration-300 ${!isClicked ? "bg-blue-500 text-white" : "bg-transparent"
                        }`}
                    style={{
                ...
                >
                    <Typography component="span">
                        ...
                        Chat History</Typography>
                </AccordionSummary>
                <AccordionDetails >
                    <Typography className={`type-txt txt-typ ${activeAcc === 0 ? 'active' : ''}`}
                        onClick={() => handleActiveAcc(0)}> 
                        - History1
                    </Typography>
                    <Typography className={`type-txt mt-2 txt-typ ${activeAcc === 1 ? 'active' : ''}`}
                        onClick={() => handleActiveAcc(1)}>
                        - History2
                    </Typography>
                    <Typography className={`type-txt mt-2 txt-typ ${activeAcc === 2 ? 'active' : ''}`}
                        onClick={() => handleActiveAcc(2)}>
                        - History3
                    </Typography>
                    <Typography className={`type-txt mt-2 txt-typ ${activeAcc === 3 ? 'active' : ''}`}
